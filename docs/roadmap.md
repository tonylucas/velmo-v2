...
| **005d** | Qualité RAG mesurée | Job périodique hors CI : échantillonnage des tours avec recherche mémoire, scoring RAGAS (faithfulness, answer_relevancy) poussé sur les traces | ⬜ | ⬜ | ⬜ | ⬜ |
